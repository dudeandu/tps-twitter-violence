// DATES:
    ...
    //"12/31/2019 23:59:59" >> 1577854799000
        ...
        var fromDate = 1420088400000;
        var toDate = 1577768400000;

        var fromHandle = 1420088400000, 
            toHandle = 1577768400000;
...
function(a, b) {
    ...
    a.widget("ui.dateRangeSlider", a.ui.rangeSlider, {
        options: {
            bounds: {
                min: new Date(2019, 0, 1).valueOf(),
                max: new Date(2019, 11, 31, 23, 59, 59).valueOf()
            },
            defaultValues: {
                min: new Date(2019, 0, 1).valueOf(),
                max: new Date(2019, 11, 31, 23, 59, 59).valueOf()
